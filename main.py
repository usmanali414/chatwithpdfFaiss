...
# Function to list PDF file paths in a folder
...
async def upload_file_path(request: Request, link: str = Form(...)):
    ...
    # print(pdf_files)
    return templates.TemplateResponse("data-retrival/index.html", {"request": request, "link_error": link_error, "link": link, "loaded_files": Doc_Path_list(pdf_files)})
...
#     return templates.TemplateResponse("data-retrival/index.html", {"request": request, "file_error": file_error,"file": file,"loaded_files":show_Docs()})
